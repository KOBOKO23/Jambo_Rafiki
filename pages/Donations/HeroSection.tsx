        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-sm mb-6">
              ...
              <span className="text-sm text-gray-600">Transform Lives Today</span>
            </div>

            <h1 className="text-5xl lg:text-6xl text-gray-900 mb-6">Support Our Mission</h1>

            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Your generous donation helps us provide care, education, healthcare, and hope to 30 orphaned children. Every contribution makes a lasting difference.
            </p>
